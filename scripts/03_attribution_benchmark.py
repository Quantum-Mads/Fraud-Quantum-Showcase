...
select_features, stratified_reduced_sample, XGB_PARAMS, N_FEATURES = (
    _m.select_features, _m.stratified_reduced_sample, _m.XGB_PARAMS, _m.N_FEATURES)
...
def main() -> None:
    ...
    mlp = StandaloneMLP(N_FEATURES, hidden=16)
